...
function Button({ children, to, disabled, type }) {
  ...
  return (
    <button disabled={disabled} className={`${styles.base} ${styles[type]}`}>
      {children}
    </button>
  );
}
